...
void syntax_go_line_handler(yed_event *event);
void syntax_go_frame_handler(yed_event *event);
void syntax_go_buff_mod_pre_handler(yed_event *event);
void syntax_go_buff_mod_post_handler(yed_event *event);
...
int yed_plugin_boot(yed_plugin *self) {
    ...
    char              *pp_kwds[] = {
        "import", "package", "defer", "go",
        "make", "chan",
    };
    char              *control_flow[] = {
        "break", "case", "continue", "default", "fallthrough", "else", "for",
        "goto", "if", "return", "switch", "range", "select",
    };
    char              *typenames[] = {
        "int", "int8", "int16", "int32", "int64",
        "uint", "uint8", "uint16", "uint32", "uint64", "uintptr",
        "float", "float32", "complex64", "complex128",
        "string", "byte", "rune",
        "bool", "map",
        "struct",
        "type",
